...
public abstract class TemperatureGUI implements java.util.Observer {
	...
	protected void setController(TemperatureController controller) {
		addRaiseTempListener(controller.getRaiseTempListener());
		addLowerTempListener(controller.getLowerTempListener());
		addDisplayListener(controller.getDisplayListener());
	}
